...
-- Table structure for SGNC_ENVIRONMENT
...
-- Table structure for SGNC_AMBIENCE
...
-- Table structure for SGNC_KUBERNETS
...
-- Table structure for SGNC_APPLICATIONS_NAMES
